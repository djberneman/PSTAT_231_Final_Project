...
```
![*Variable Correlation Plot*]("ConfusionMatrix.jpg")
...
class_tree_final <- finalize_orkflow(class_tree_wf, best_complexity)
...
It looks like the decision tree is the best method to determine the location a single observation of data. With around a 61% rate of accuracy, the model is capable of determining which state or territory of the United States an observationaal point of data is from.
